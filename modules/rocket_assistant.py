...
class RocketAssistant:
    ...
    # "rocket_config": {
    #     "calib_dists": [16.4, 19.8, 24.4, 26.1, 29.0, 30.5, 33.6, 35.1, 36.7, 41.2, 44.3, 47.3, 51.1, 57.2, 63.3, 69.5, 77.1, 84.7, 92.4, 101.7, 110.7, 120.0, 129.1, 138.3, 146.0, 155.2, 164.4],
    #     "calib_ratios": [0.0532, 0.0648, 0.0856, 0.0949, 0.1157, 0.1319, 0.1435, 0.1667, 0.1852, 0.1968, 0.2054, 0.2361, 0.2523, 0.2894, 0.3333, 0.3819, 0.4190, 0.4907, 0.5301, 0.5972, 0.7222, 0.2161, 0.2523, 0.2894, 0.3333, 0.3819, 0.4190],
    #     "end_y_ratio": 0.9
    # },
